...
while True:
    s = str(input("If you want to end the game, enter Stop, otherwise press Enter:"))
    if s == "Stop":
        break
    def load_words():
        """
    ...
    def hangman(secret_word):
        ...
        word_lenth = len(secret_word)
        print("Welcome to the game Hangman!")
        print("I am thinking of a word that is",word_lenth,"letters long.")
        ...
        while Ranner == False:
            ...
            while True:  # Перевірка типу даних
                try:
                    letter = str(input("Please guess a letter:"))  # Вводимо дані
                    ...
                    while len(letter) != 1 or letter.isalpha() == False:
                        ...
                        warnings -= 1
                        if letter.isalpha() == False and warnings < 0:
                            guesses -= 1
                            print("Oops! That is not a valid letter.")
                            print("Oops! You have no warnings left.")
            ...
            if letter in letters_guessed and (letter in secret_word or letter not in secret_word):
                warnings -= 1
                if  warnings < 0:
                    guesses -= 1
            ...
            if guesses <= 0:
                ...
                secret_word = list(set(secret_word))
                mult = len(secret_word)
                print("Congratulations, you won! Your total score for this game is:",guesses * mult)
                print("______________________")
                break
            else: pass
    ...
    def match_with_gaps(my_word, other_word):
        ...
        if len(my_word) == len(other_word):
            for i in other_word:
                if i not in my_word:
                    other_word = other_word.replace(i, '_')
        ...
        while Ranner == False:
            ...
            if letter in letters_guessed and (letter in secret_word or letter not in secret_word):
                ...
                if warnings < 0:
                    ...
                    print("Possible word matches are:",show_possible_matches(my_word),".")
            else:
                letters_guessed += letter
                if letter in secret_word:
                    print("Good guess:", get_guessed_word(secret_word, letters_guessed),".")
